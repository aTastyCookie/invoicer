...
<head>
    ...
    <link href="{{ $protocol }}://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css" rel="stylesheet">
    ...
    <script src="{{ $protocol }}://code.jquery.com/jquery.min.js"></script>
    <script src="{{ $protocol }}://code.jquery.com/ui/1.11.2/jquery-ui.min.js"></script>
    <script src="{{ $protocol }}://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js"></script>
