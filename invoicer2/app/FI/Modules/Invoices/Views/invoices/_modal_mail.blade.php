<script type="text/javascript">
    var mailInvoiceRoute = '{{ route('invoices.ajax.mailInvoice') }}';
...
<script src="{{ asset('js/FI/invoice_mail.js') }}" type="text/javascript"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn-submit-mail-invoice" class="btn btn-primary">{{ trans('fi.send') }}</button>
            </div>
        </div>
    </div>
</div>