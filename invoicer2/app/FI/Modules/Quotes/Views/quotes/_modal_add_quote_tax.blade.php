	...
	$(function()
	{
		...
		$('#btn-submit-quote-tax').click(function()
		{
			$.post("{{ route('quotes.ajax.saveQuoteTax') }}", { 
				...
				window.location = "{{ route('quotes.edit', array($quote_id)) }}";
...
<div class="modal fade" id="add-quote-tax">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn-submit-quote-tax" class="btn btn-primary">{{ trans('fi.submit') }}</button>
            </div>
        </div>
    </div>
</div>