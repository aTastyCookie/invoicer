...
return array(
	...
	*/
	...
	"between"          => array(
		...
		"array"   => ":attribute debe tener entre :min - :max artículos.",
	),
	...
	"required_with"    => ":attribute es obligatorio cuando when :values está presente.",
	"required_without" => ":attribute es obligatorio cuando when :values no está presente.",
	...
	"url"              => ":attribute formato no válido.",
