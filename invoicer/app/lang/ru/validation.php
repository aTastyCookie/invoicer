...
return array(
	...
	*/
	...
	"between"          => array(
		...
		"file"    => ":attribute должен быть в пределе :min - :max kilobytes.",
		"string"  => ":attribute должен быть в пределе :min - :max characters.",
		"array"   => ":attribute должен быть пределе :min - :max items.",
	),
	"confirmed"        => "The :attribute confirmation does not match.",
	"date"             => ":attribute не похож на настоящую дату.",
